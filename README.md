...
```
bash <(curl -Ls https://raw.githubusercontents.com/weongit/XrayR-onekey-weongit/master/install.sh)
```
# Docker 安装
...
```
1. `git clone https://github.com/Misaka-blog/XrayR-script XrayR-release`
2. `cd XrayR-release`
3. 编辑config。
